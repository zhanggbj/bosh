...
module Bosh::Director
  describe CloudcheckHelper do
    ...
    before do
      allow(AgentClient).to receive(:with_vm_credentials_and_agent_id).with(instance.credentials_json, instance.agent_id, anything).and_return(agent_client)
    ...
    describe '#recreate_vm' do
      ...
      describe 'actually recreating the VM' do
        ...
        before do
          ...
          allow(AgentClient).to receive(:with_vm_credentials_and_agent_id).with(instance.credentials_json, instance.agent_id, anything).and_return(fake_new_agent)
          allow(AgentClient).to receive(:with_vm_credentials_and_agent_id).with(instance.credentials_json, instance.agent_id).and_return(fake_new_agent)
