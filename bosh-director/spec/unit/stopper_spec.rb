...
module Bosh::Director
  describe Stopper do
    ...
    context 'when trying to stop instances' do
      let(:instance) { instance_double(DeploymentPlan::Instance, model: instance_model) }
      let(:instance_plan) { DeploymentPlan::InstancePlan.new(existing_instance: instance_model, instance: instance, desired_instance: nil) }
