...
describe Bosh::Director::ProblemHandlers::InactiveDisk do
  ...
  before(:each) do
    ...
    @instance = Bosh::Director::Models::Instance.
      make(:job => 'mysql_node', :index => 3, :uuid => '52C6C66A-6DF3-4D4E-9EB1-FFE63AD755D7', credentials_json: '{"credentials" => "json"}')
    ...
    allow(@handler).to receive(:agent_client).with(@instance.credentials_json, @instance.agent_id).and_return(@agent)
  end
