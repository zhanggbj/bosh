module Bosh::Director
  class Stopper
    def initialize(instance_plan, target_state, skip_drain, config, logger)
      ...
      @instance_model = @instance_plan.obsolete? ? instance_plan.existing_instance : instance_plan.instance.model
    ...
    def perform_drain
      ...
      drain_time = agent_client.drain(drain_type, @instance_model.vm.apply_spec)
