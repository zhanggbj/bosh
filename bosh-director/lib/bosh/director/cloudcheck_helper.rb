...
module Bosh::Director
  module CloudcheckHelper
    ...
    def reboot_vm(instance)
      ...
      begin
        agent_client(instance.credentials_json, instance.agent_id).wait_until_ready
    ...
    def delete_vm(instance)
      ...
      disk_list = agent_timeout_guard(instance.vm_cid, instance.credentials_json, instance.agent_id) { |agent| agent.list_disk }
      if disk_list.size != 0
    ...
    def recreate_vm(instance)
      ...
      existing_agent_id = instance.agent_id
      ...
      InstanceUpdater::StateApplier.new(instance_plan_to_create, agent_client(instance.credentials_json, instance.agent_id), cleaner, @logger).apply
    end
